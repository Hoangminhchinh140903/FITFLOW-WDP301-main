const SALE_ORDER_STATUS_META = {
  ...
  ReturnRequested: { label: 'Yêu cầu trả hàng', badgeClass: 'bg-orange-100 text-orange-700' },
  Returned: { label: 'Đã trả hàng', badgeClass: 'bg-slate-200 text-slate-700' },
...
const SALE_ORDER_TRANSITIONS = {
  ...
  Shipping: ['Completed', 'Returned', 'ReturnRequested', 'Cancelled'],
  Completed: ['ReturnRequested', 'Returned'],
