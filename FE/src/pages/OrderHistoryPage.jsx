          ...
          {order.type === 'rent' ? (
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50/80 p-5">
              ...
              <p className="mt-2 text-sm text-slate-600">
                {order.customerNote || 'FITFLOW đang chuẩn bị đơn hàng của bạn với tiêu chuẩn đóng gói chỉn chu và giao đúng lịch hẹn.'}
              </p>
            </div>
          )}
  ...
  return (
    <div className="rounded-[32px] border border-dashed border-slate-200 bg-white/90 px-6 py-14 text-center shadow-[0_20px_60px_rgba(15,23,42,0.05)]">
      ...
      <p className="mx-auto mt-3 max-w-xl text-sm leading-6 text-slate-500">
        Khám phá các bộ sưu tập sản phẩm và bắt đầu đơn đầu tiên của bạn.
      </p>
      <Link
        to="/buy"
