            ...
            {profileLoading ? (
              ...
              <>
                <div className="profile-content-header">
                  ...
                  <p>{activeTab === 'profile' ? 'Cập nhật thông tin liên hệ để nhận hỗ trợ nhanh hơn từ FITFLOW.' : activeTab === 'password' ? 'Đổi mật khẩu định kỳ để bảo mật tài khoản của bạn.' : 'Tải ảnh rõ mặt để nhân viên hỗ trợ nhận diện nhanh khi nhận đồ.'}</p>
                </div>
