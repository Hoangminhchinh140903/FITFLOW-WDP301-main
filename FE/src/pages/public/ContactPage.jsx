      ...
      <main className="mx-auto max-w-6xl px-4 py-8 md:px-6 lg:px-8">
        <section className="rounded-[28px] border border-white/70 bg-white/95 p-6 shadow-[0_24px_80px_rgba(15,23,42,0.08)] md:p-8">
          ...
          <p className="mt-3 max-w-3xl text-slate-600">
            FITFLOW hỗ trợ tư vấn chọn sản phẩm, đặt lịch thuê vợt, theo dõi đơn hàng và giải đáp chính sách thuê/mua.
            Bạn có thể liên hệ trực tiếp qua điện thoại, Zalo hoặc đến cửa hàng.
          </p>
        </section>

        <section className="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          <a href="tel:0936295902" className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
            <Phone className="h-5 w-5 text-amber-600" />
            <p className="mt-3 text-sm text-slate-500">Hotline</p>
            <p className="mt-1 text-lg font-semibold text-slate-900">0936 295 902</p>
          </a>

          <a href="mailto:[EMAIL_ADDRESS]" className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
            <Mail className="h-5 w-5 text-amber-600" />
            <p className="mt-3 text-sm text-slate-500">Thư điện tử</p>
            <p className="mt-1 text-lg font-semibold text-slate-900">fitflow.contact@gmail.com</p>
          </a>
        ...
        <section className="mt-6 grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-2 text-slate-600">Thanh Xuân, Hà Nội</p>
            <a
