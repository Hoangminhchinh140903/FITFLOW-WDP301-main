  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Quản lý booking thuê vợt</h2>
          <p className="text-sm text-slate-600">
            {readOnly ? 'Theo dõi danh sách booking thuê vợt (chỉ xem)' : 'Xử lý và phản hồi booking của khách'}
          </p>
        </div>
