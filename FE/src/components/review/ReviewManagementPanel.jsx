                ...
                <tr key={row._id} className="border-b border-slate-100 last:border-b-0 hover:bg-slate-50/60">
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-3">
                      <img src={row?.product?.images?.[0] || 'https://placehold.co/80x80/f8fafc/64748b?text=FITFLOW'} alt="Sản phẩm" className="h-10 w-10 rounded-lg object-cover ring-1 ring-slate-200" />
