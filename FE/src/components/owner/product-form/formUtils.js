...
export const createValidationErrors = (form) => {
    ...
    if (toPositiveNumber(form.baseSalePrice, -1) < 0) {
        errors.baseSalePrice = 'Giá bán phải lớn hơn hoặc bằng 0.'
    }

    if (toPositiveNumber(form.baseRentPrice, -1) < 0) {
        errors.baseRentPrice = 'Giá thuê phải lớn hơn hoặc bằng 0.'
    }
